                ...
                <div class="bg-primary bg-soft">
                    <div class="row">
                        ...
                        <div class="col-5 align-self-end">
                            <img src="{{ asset('backend_assets/images/profile-img.png') }}" alt="" class="img-fluid">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="avatar-md profile-user-wid mb-4">
                                <img src="{{ asset('backend_assets/images/users/avatar-1.jpg') }}" alt="" class="img-thumbnail rounded-circle">
                            </div>
                            <h5 class="font-size-15 text-truncate">{{ Auth::guard('admin')->user()->name ?? 'Administrator' }}</h5>
                        ...
                        <div class="card-body">
                            <div class="d-flex">
                                <div class="flex-grow-1">
                                    <p class="text-muted fw-medium">Total Signups</p>
                                    <h4 class="mb-0">{{ $totalSignups ?? 0 }}</h4>
                                </div>
                ...
                <div class="col-md-4">
                    <div class="card mini-stats-wid">
                        <div class="card-body">
                            <div class="d-flex">
                                <div class="flex-grow-1">
                                    <p class="text-muted fw-medium">Booked Calls</p>
                                    <h4 class="mb-0">{{ $totalCalls ?? 0 }}</h4>
                                </div>
                ...
                <div class="col-md-4">
                    <div class="card mini-stats-wid">
                        <div class="card-body">
                            <div class="d-flex">
                                <div class="flex-grow-1">
                                    <p class="text-muted fw-medium">Booked Visits</p>
                                    <h4 class="mb-0">{{ $totalVisits ?? 0 }}</h4>
                                </div>
