    ...
    document.getElementById("header-lang-img") &&
      ("en" == e
        ? (document.getElementById("header-lang-img").src =
            "{{ asset('backend_assets/images/flags/us.jpg') }}")
        : "sp" == e
        ? (document.getElementById("header-lang-img").src =
            "{{ asset('backend_assets/images/flags/spain.jpg') }}")
        : "gr" == e
        ? (document.getElementById("header-lang-img").src =
            "{{ asset('backend_assets/images/flags/germany.jpg') }}")
        : "it" == e
        ? (document.getElementById("header-lang-img").src =
            "{{ asset('backend_assets/images/flags/italy.jpg') }}")
        : "ru" == e &&
          (document.getElementById("header-lang-img").src =
            "{{ asset('backend_assets/images/flags/russia.jpg') }}"),
